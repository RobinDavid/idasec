...
from PySide.QtGui import QFileDialog, QTableWidgetItem, QTreeWidgetItem
...
class TraceWidget(QtGui.QWidget):
    ...
    def load_trace(self):
        ...
        if filepath.exists() and filepath.isfile():
            ...
            try:
                ...
                newtable = QtGui.QTableWidget(self)
                ...
                newtable.horizontalHeader().setResizeMode(newtable.horizontalHeader().ResizeToContents)
                self.connect(newtable, QtCore.SIGNAL("currentItemChanged(QTableWidgetItem*, QTableWidgetItem*)"), self.update_instruction_informations)
                self.connect(newtable, QtCore.SIGNAL("itemDoubleClicked(QTableWidgetItem*)"), self.go_to_instruction)
    ...
    def setupUi(self, trace_form):
        ...
        self.verticalLayout_3 = QtGui.QVBoxLayout(trace_form)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.splitter = QtGui.QSplitter(trace_form)
        ...
        self.traces_tab = QtGui.QTabWidget(self.verticalLayoutWidget)
        ...
        self.loading_stat = QtGui.QLabel(self.verticalLayoutWidget)
        ...
        self.progressbar_loading = QtGui.QProgressBar(self.verticalLayoutWidget)
        ...
        self.add_trace_button = QtGui.QPushButton(self.verticalLayoutWidget)
        ...
        self.trace_infos_title = QtGui.QLabel(self.verticalLayoutWidget_2)
        ...
        self.trace_infos = QtGui.QLabel(self.verticalLayoutWidget_2)
        ...
        self.reads_view = QtGui.QTreeWidget(self.verticalLayoutWidget_2)
        ...
        self.writes_view = QtGui.QTreeWidget(self.verticalLayoutWidget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.additional_infos = QtGui.QTextEdit(self.verticalLayoutWidget_2)
        ...
        self.dump_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        ...
        self.disassemble_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        ...
        self.colorize_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        self.colorize_button.setObjectName(_fromUtf8("colorize_button"))
        self.gridLayout_2.addWidget(self.colorize_button, 1, 1, 1, 1)
        self.heatmap_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
