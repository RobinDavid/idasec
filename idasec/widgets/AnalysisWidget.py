...
from PySide.QtGui import QTableWidgetItem, QComboBox, QInputDialog, QMessageBox, QFileDialog
...
class AnalysisWidget(QtGui.QWidget):
    ...
    def OnCreate(self):
        ...
        self.inputs_table.horizontalHeader().setResizeMode(self.inputs_table.horizontalHeader().ResizeToContents)
        ...
        self.policy_table.horizontalHeader().setResizeMode(self.policy_table.horizontalHeader().ResizeToContents)


        # --- Initialize events
        self.connect(self.add_input_button, QtCore.SIGNAL("clicked()"), self.add_input_action)
        self.connect(self.add_initial_state_button, QtCore.SIGNAL("clicked()"), self.add_initial_state_action)
        self.connect(self.add_bp_button, QtCore.SIGNAL("clicked()"), self.add_bp_action)
        self.connect(self.remove_bp_button, QtCore.SIGNAL("clicked()"), self.remove_bp_action)
        self.connect(self.detect_start_button, QtCore.SIGNAL("clicked()"), self.detect_start_action)
        self.connect(self.detect_stop_button, QtCore.SIGNAL("clicked()"), self.detect_stop_action)
        self.connect(self.analysis_name_selector, QtCore.SIGNAL("currentIndexChanged(QString)"), self.analysis_name_changed)
        self.connect(self.direction_selector, QtCore.SIGNAL("currentIndexChanged(QString)"), self.direction_selector_changed)
        self.connect(self.local_radiobutton, QtCore.SIGNAL("toggled(bool)"), self.local_radiobutton_toggled)
        self.connect(self.policy_selector, QtCore.SIGNAL("currentIndexChanged(QString)"), self.policy_selector_changed)
        self.connect(self.add_policy_item_button, QtCore.SIGNAL("clicked()"), self.add_policy_item_action)
        self.connect(self.remove_policy_item_button, QtCore.SIGNAL("clicked()"), self.remove_policy_item_action)
        self.connect(self.help_policy_button, QtCore.SIGNAL('clicked()'), self.help_policy_action)
        self.connect(self.add_libcall_button, QtCore.SIGNAL('clicked()'), self.add_libcall_action)
        self.connect(self.remove_libcall_button, QtCore.SIGNAL('clicked()'), self.remove_libcall_action)
        self.connect(self.add_syscall_button, QtCore.SIGNAL('clicked()'), self.add_syscall_action)
        self.connect(self.remove_syscall_button, QtCore.SIGNAL('clicked()'), self.remove_syscall_action)
        self.connect(self.add_instruction_button, QtCore.SIGNAL('clicked()'), self.add_instr_action)
        self.connect(self.remove_instruction_button, QtCore.SIGNAL('clicked()'), self.remove_instr_action)
        self.connect(self.save_config_button, QtCore.SIGNAL("clicked()"), self.save_config_clicked)
        self.connect(self.load_config_button, QtCore.SIGNAL("clicked()"), self.load_config_clicked)
        self.connect(self.generate_config_button, QtCore.SIGNAL("clicked()"), self.generate_config_clicked)
        self.connect(self.trigger_analysis_button, QtCore.SIGNAL("clicked()"), self.trigger_analysis_clicked)
    ...
    def input_item_keypressed(self, event):
        ...
        return QtGui.QTableWidget.keyPressEvent(self.inputs_table, event)
    ...
    def initial_state_keypressed(self, event):
        if event.key() == QtCore.Qt.Key_Delete:
            ...
            del it
        return QtGui.QListWidget.keyPressEvent(self.initial_state_list, event)
...
#------------------------------------------------------------------------
    ...
    def setupUi(self, Analysis):
        ...
        self.verticalLayout_3 = QtGui.QVBoxLayout(Analysis)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.splitter = QtGui.QSplitter(Analysis)
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName(_fromUtf8("splitter"))
        self.verticalLayoutWidget = QtGui.QWidget(self.splitter)
        self.verticalLayoutWidget.setObjectName(_fromUtf8("verticalLayoutWidget"))
        self.left_layout = QtGui.QVBoxLayout(self.verticalLayoutWidget)
        self.left_layout.setSizeConstraint(QtGui.QLayout.SetDefaultConstraint)
        self.left_layout.setObjectName(_fromUtf8("left_layout"))
        self.configuration_label = QtGui.QLabel(self.verticalLayoutWidget)
        ...
        self.configuration_textarea = QtGui.QTextEdit(self.verticalLayoutWidget_4)
        ...
        self.verticalLayoutWidget_5 = QtGui.QWidget(self.splitter_2)
        self.verticalLayoutWidget_5.setObjectName(_fromUtf8("verticalLayoutWidget_5"))
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.verticalLayoutWidget_5)
        self.verticalLayout_11.setObjectName(_fromUtf8("verticalLayout_11"))
        self.common_group = QtGui.QGroupBox(self.verticalLayoutWidget_5)
        ...
        self.verticalLayout_13 = QtGui.QVBoxLayout(self.common_group)
        self.verticalLayout_13.setObjectName(_fromUtf8("verticalLayout_13"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.input_label = QtGui.QLabel(self.common_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.inputs_table = QtGui.QTableWidget(self.common_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.add_input_button = QtGui.QPushButton(self.common_group)
        ...
        self.initial_state_label = QtGui.QLabel(self.common_group)
        self.initial_state_label.setFrameShape(QtGui.QFrame.NoFrame)
        ...
        self.initial_state_from = QtGui.QLabel(self.common_group)
        ...
        self.initial_state_from_field = QtGui.QLineEdit(self.common_group)
        ...
        self.initial_state_to_label = QtGui.QLabel(self.common_group)
        ...
        self.initial_state_to_field = QtGui.QLineEdit(self.common_group)
        ...
        self.add_initial_state_button = QtGui.QPushButton(self.common_group)
        ...
        self.initial_state_list = QtGui.QListWidget(self.common_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pinsec_group = QtGui.QGroupBox(self.scrollAreaWidgetContents)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.pinsec_group)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.horizontalLayout = QtGui.QHBoxLayout()
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.bp_label = QtGui.QLabel(self.pinsec_group)
        ...
        self.bp_list = QtGui.QComboBox(self.pinsec_group)
        self.bp_list.setObjectName(_fromUtf8("bp_list"))
        self.horizontalLayout.addWidget(self.bp_list)
        self.add_bp_button = QtGui.QPushButton(self.pinsec_group)
        ...
        self.remove_bp_button = QtGui.QPushButton(self.pinsec_group)
        ...
        self.start_label = QtGui.QLabel(self.pinsec_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.start_field = QtGui.QLineEdit(self.pinsec_group)
        ...
        self.detect_start_button = QtGui.QPushButton(self.pinsec_group)
        ...
        self.stop_label = QtGui.QLabel(self.pinsec_group)
        ...
        self.stop_field = QtGui.QLineEdit(self.pinsec_group)
        ...
        self.detect_stop_button = QtGui.QPushButton(self.pinsec_group)
        ...
        self.start_entrypoint_checkbox = QtGui.QCheckBox(self.pinsec_group)
        ...
        self.trace_waves_checkbox = QtGui.QCheckBox(self.pinsec_group)
        ...
        self.antidebug_checkbox = QtGui.QCheckBox(self.pinsec_group)
        ...
        self.analysis_group = QtGui.QGroupBox(self.scrollAreaWidgetContents)
        self.analysis_group.setObjectName(_fromUtf8("analysis_group"))
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.analysis_group)
        self.verticalLayout_5.setObjectName(_fromUtf8("verticalLayout_5"))
        self.horizontalLayout_7 = QtGui.QHBoxLayout()
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.analysis_name_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.analysis_name_selector = QtGui.QComboBox(self.analysis_group)
        ...
        self.direction_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.direction_selector = QtGui.QComboBox(self.analysis_group)
        ...
        self.k_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.k_spinbox = QtGui.QSpinBox(self.analysis_group)
        ...
        self.callcvt_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.callcvt_selector = QtGui.QComboBox(self.analysis_group)
        ...
        self.trace_input_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.remote_radiobutton = QtGui.QRadioButton(self.analysis_group)
        ...
        self.local_radiobutton = QtGui.QRadioButton(self.analysis_group)
        self.local_radiobutton.setObjectName(_fromUtf8("local_radiobutton"))
        self.verticalLayout_10.addWidget(self.local_radiobutton)
        self.stream_radiobutton = QtGui.QRadioButton(self.analysis_group)
        ...
        self.trace_label = QtGui.QLabel(self.analysis_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.trace_selector = QtGui.QComboBox(self.analysis_group)
        ...
        self.callmap_checkbox = QtGui.QCheckBox(self.analysis_group)
        ...
        self.verbosity_slider.setTickPosition(QtGui.QSlider.TicksBelow)
        ...
        self.analysis_specific_group = QtGui.QGroupBox(self.analysis_group)
        self.analysis_specific_group.setObjectName(_fromUtf8("analysis_specific_group"))
        self.analysis_specific_layout = QtGui.QVBoxLayout(self.analysis_specific_group)
        ...
        self.cocnsymb_group = QtGui.QGroupBox(self.analysis_group)
        self.cocnsymb_group.setObjectName(_fromUtf8("cocnsymb_group"))
        self.verticalLayout_6 = QtGui.QVBoxLayout(self.cocnsymb_group)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.policy_layout = QtGui.QHBoxLayout()
        self.policy_layout.setObjectName(_fromUtf8("policy_layout"))
        self.policy_label = QtGui.QLabel(self.cocnsymb_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.policy_selector = QtGui.QComboBox(self.cocnsymb_group)
        ...
        self.add_policy_item_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.remove_policy_item_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.help_policy_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.policy_table = QtGui.QTableWidget(self.cocnsymb_group)
        ...
        self.libcall_label = QtGui.QLabel(self.cocnsymb_group)
        ...
        self.libcall_selector = QtGui.QComboBox(self.cocnsymb_group)
        ...
        self.add_libcall_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.remove_libcall_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.syscall_label = QtGui.QLabel(self.cocnsymb_group)
        ...
        self.syscall_selector = QtGui.QComboBox(self.cocnsymb_group)
        ...
        self.add_syscall_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.remove_syscall_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.instruction_label = QtGui.QLabel(self.cocnsymb_group)
        ...
        self.instruction_selector = QtGui.QComboBox(self.cocnsymb_group)
        ...
        self.add_instruction_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.remove_instruction_button = QtGui.QPushButton(self.cocnsymb_group)
        ...
        self.default_action_label = QtGui.QLabel(self.cocnsymb_group)
        ...
        self.default_action_selector = QtGui.QComboBox(self.cocnsymb_group)
        ...
        self.solving_group = QtGui.QGroupBox(self.analysis_group)
        self.solving_group.setObjectName(_fromUtf8("solving_group"))
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.solving_group)
        self.verticalLayout_8.setObjectName(_fromUtf8("verticalLayout_8"))
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.solver_label = QtGui.QLabel(self.solving_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.solver_selector = QtGui.QComboBox(self.solving_group)
        ...
        self.incremental_solving_checkbox = QtGui.QCheckBox(self.solving_group)
        ...
        self.timeout_label = QtGui.QLabel(self.solving_group)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.load_config_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        ...
        self.save_config_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        ...
        self.generate_config_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
        ...
        self.trigger_analysis_button = QtGui.QPushButton(self.verticalLayoutWidget_2)
