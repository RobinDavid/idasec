...
class MainWidget(QtWidgets.QWidget):
    ...
    def OnCreate(self, form):
        ...
        #self.idasec_title.clicked.emit(self.change_logo)
    ...
    def setupUi(self, Main):
        ...
        self.idasec_title = QtWidgets.QLabel(Main)
        font = QtGui.QFont()
        ...
        self.binsec_port_field = QtWidgets.QLineEdit(Main)
        ...
        self.binsec_connect_button = QtWidgets.QPushButton(Main)
        ...
        self.binsec_label_status = QtWidgets.QLabel(Main)
        ...
        self.pinsec_port_field = QtWidgets.QLineEdit(Main)
        ...
        self.pinsec_connect_button = QtWidgets.QPushButton(Main)
        ...
        self.pinsec_label_status = QtWidgets.QLabel(Main)
        ...
        self.utils_label = QtWidgets.QLabel(Main)
        self.utils_label.setEnabled(False)
        font = QtGui.QFont()
        ...
        self.ir_textarea = QtWidgets.QTextEdit(Main)
        self.ir_textarea.setEnabled(False)
        font = QtGui.QFont()
        ...
        self.dba_decode_button.clicked.connect(self.ir_textarea.clear)
