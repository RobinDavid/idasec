...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_pb2.DESCRIPTOR,libcall_pb2.DESCRIPTOR,syscall_pb2.DESCRIPTOR,instruction_pb2.DESCRIPTOR,analysis_config_pb2.DESCRIPTOR,])
...
_CONFIGURATION.fields_by_name['libcalls'].message_type = libcall_pb2._LIBCALL_POL
_CONFIGURATION.fields_by_name['syscalls'].message_type = syscall_pb2._SYSCALL_POL
_CONFIGURATION.fields_by_name['instrs'].message_type = instruction_pb2._INSTR_POL
...
_CONFIGURATION.fields_by_name['initial_state'].message_type = common_pb2._MEMORY_T
_CONFIGURATION.fields_by_name['direction'].enum_type = common_pb2._ANALYSIS_DIRECTION_T
_CONFIGURATION.fields_by_name['solver'].enum_type = common_pb2._SOLVER_T
_CONFIGURATION.fields_by_name['callcvt'].enum_type = common_pb2._CALL_CONVENTION_T
_CONFIGURATION.fields_by_name['default_action'].enum_type = common_pb2._ACTION
_CONFIGURATION.fields_by_name['additional_parameters'].message_type = analysis_config_pb2._SPECIFIC_PARAMETERS_T
_INPUT_T.fields_by_name['typeid'].enum_type = _INPUT_T_INPUT_KIND
_INPUT_T.fields_by_name['when'].enum_type = _INPUT_T_WHEN_T
_INPUT_T.fields_by_name['action'].enum_type = common_pb2._ACTION
_INPUT_T.fields_by_name['reg'].message_type = common_pb2._REGISTER_T
_INPUT_T.fields_by_name['mem'].message_type = common_pb2._MEMORY_T
_INPUT_T.fields_by_name['indirect'].message_type = common_pb2._INDIRECT_REGISTER_T
